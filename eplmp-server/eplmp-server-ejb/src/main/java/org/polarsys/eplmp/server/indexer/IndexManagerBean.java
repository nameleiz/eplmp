...
public class IndexManagerBean {
    ...
    private void createIndex(String indexName) throws IndexerNotAvailableException, IndexerRequestException {
        Settings settings = Settings.builder()
                .put(IndexerConfig.NUMBER_OF_SHARDS, config.getNumberOfShards())
                .put(IndexerConfig.NUMBER_OF_REPLICAS, config.getNumberOfReplicas())
                .put(IndexerConfig.AUTO_EXPAND_REPLICAS, config.getAutoExpandReplicas())
                .build();
